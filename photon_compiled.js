...
lt.plugins.photon.selector.selector = (function selector(opts){var G__8331 = lt.objs.sidebar.command.filter_list.call(null,opts);lt.object.add_behavior_BANG_.call(null,G__8331,new cljs.core.Keyword("lt.plugins.photon.selector","set-selected","lt.plugins.photon.selector/set-selected",4322650788));
return G__8331;
});
}
...
lt.plugins.photon.__GT_items = (function __GT_items(path){var children = lt.objs.files.ls_sync.call(null,path,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"dirs","dirs",1016987896),true], null));return cljs.core.map.call(null,(function (p1__8354_SHARP_){return cljs.core.PersistentHashMap.fromArrays.call(null,[new cljs.core.Keyword(null,"name","name",1017277949),new cljs.core.Keyword(null,"path","path",1017337751)],[lt.objs.files.basename.call(null,p1__8354_SHARP_),lt.objs.files.join.call(null,path,p1__8354_SHARP_)]);
}),children);
});
lt.plugins.photon.add_items = (function add_items(){return cljs.core.sort_by.call(null,new cljs.core.Keyword(null,"name","name",1017277949),cljs.core.mapcat.call(null,lt.plugins.photon.__GT_items,cljs.core.map.call(null,lt.plugins.photon.expand_path,cljs.core.map.call(null,(function (p1__8355_SHARP_){if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"plugins","plugins",538274578),p1__8355_SHARP_))
{return lt.objs.plugins.user_plugins_dir;
} else
{return [cljs.core.str(p1__8355_SHARP_)].join('');
}
}),cljs.core.deref.call(null,lt.plugins.photon.directories)))));
});
lt.plugins.photon.add_selector = lt.plugins.photon.selector.selector.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"items","items",1114430258),lt.plugins.photon.add_items,new cljs.core.Keyword(null,"key","key",1014010321),new cljs.core.Keyword(null,"name","name",1017277949),new cljs.core.Keyword(null,"transform","transform",2066570974),(function (p1__8358_SHARP_,p2__8359_SHARP_,p3__8356_SHARP_,p4__8357_SHARP_){return [cljs.core.str("<p>"),cljs.core.str(p3__8356_SHARP_),cljs.core.str("</p><p class='binding'>"),cljs.core.str(new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(p4__8357_SHARP_)),cljs.core.str("</p>")].join('');
})], null));
...
lt.plugins.photon.remove_selector = lt.plugins.photon.selector.selector.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"items","items",1114430258),(function (){return cljs.core.map.call(null,(function (p1__8360_SHARP_){return cljs.core.PersistentHashMap.fromArrays.call(null,[new cljs.core.Keyword(null,"path","path",1017337751),new cljs.core.Keyword(null,"name","name",1017277949)],[p1__8360_SHARP_,lt.objs.files.basename.call(null,p1__8360_SHARP_)]);
...
}),new cljs.core.Keyword(null,"key","key",1014010321),new cljs.core.Keyword(null,"name","name",1017277949),new cljs.core.Keyword(null,"transform","transform",2066570974),(function (p1__8363_SHARP_,p2__8364_SHARP_,p3__8361_SHARP_,p4__8362_SHARP_){return [cljs.core.str("<p>"),cljs.core.str(p3__8361_SHARP_),cljs.core.str("</p><p class='binding'>"),cljs.core.str(new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(p4__8362_SHARP_)),cljs.core.str("</p>")].join('');
})], null));
